...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--top10-xpass", "--top10_xpass", dest="top10_xpass", action="store_true", help="Use pc-xPass top10 columns for inference blending and physical xPass rendering.")
