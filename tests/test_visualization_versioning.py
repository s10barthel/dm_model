    ...
    def test_direct_hawkeye_visualization_records_model_ids(self) -> None:
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            def fake_render_situation(
                ...
                del tracking, ball, model_specs, graph_schema, args, device
            ...
            with (
                ...
                patch.object(run_and_visualize_hawkeye, "load_hawkeye_models", return_value={}),
                patch.object(
