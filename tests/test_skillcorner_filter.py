...
def test_filter_skillcorner_actions_raw_keeps_only_known_players() -> None:
    skillcorner_data = pd.DataFrame(
        [
            {"player_id": 10, "match_id": "m1", "pass_score": 0.1, "game_state_value": 0.2, "dm_score": 0.3, "extra": "keep"},
            {"player_id": 20, "match_id": "m2", "pass_score": 0.4, "game_state_value": 0.5, "dm_score": 0.6, "extra": "drop"},
        ]
    )
