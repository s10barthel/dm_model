...
NODE_FEATURE_IS_TEAMMATE = 0
NODE_FEATURE_IS_KEEPER = 1
NODE_FEATURE_IS_GOAL = 2
NODE_FEATURE_X = 3
NODE_FEATURE_Y = 4
NODE_FEATURE_VX = 5
NODE_FEATURE_VY = 6
NODE_FEATURE_SPEED = 7
NODE_FEATURE_ACCEL = 8
NODE_FEATURE_GOAL_DIST = 9
NODE_FEATURE_GOAL_DX_NORM = 10
NODE_FEATURE_GOAL_DY_NORM = 11
NODE_FEATURE_BALL_Z = 12
NODE_FEATURE_IS_POSSESSOR = 13
NODE_FEATURE_POSS_DIST = 14
NODE_FEATURE_POSS_DX_NORM = 15
NODE_FEATURE_POSS_DY_NORM = 16
NODE_FEATURE_POSS_VANGLE_COS = 17
NODE_FEATURE_POSS_VANGLE_SIN = 18
NODE_FEATURE_CORE_DIM = 19
NODE_FEATURE_EXTENDED_START = NODE_FEATURE_CORE_DIM
NODE_FEATURE_EXTENDED_END = 25
NODE_FEATURE_MIN_EXTENDED_DIM = NODE_FEATURE_EXTENDED_END
NODE_FEATURE_NEAREST_OPPONENT_TO_PASS = 22
NODE_FEATURE_POTENTIAL_INTERCEPTORS = 23
NODE_FEATURE_OFFSIDE_DIMS = (20, 24, 26)
